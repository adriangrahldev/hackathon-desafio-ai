...
import jsonData from "../assets/lugares.json"
...
export async function queryChatGPTWithJsonData(query) {
    const context = jsonData;
    const promptData = `Dada la siguiente información, solo responde en base a la misma: ${JSON.stringify(context)}, ${query}`;
